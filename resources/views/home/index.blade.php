    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa fa-tags"></i><span class="break"></span>Quick Links</h2> 
            </div>
            <div class="box-content">
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bblue white quick-button large" href="{{url('/products')}}">
                        <div class="text-center">
                            <p><i class="fas fa-memory" style="color: #68035f;"></i></p>
                            <p>LIST PRODUCTS</p>
                        </div>
                    </a>
                </div> 
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bdarkGreen white quick-button large" href="{{url('/sells')}}">
                        <div class="text-center">
                            <p><i class="fas fa-piggy-bank" style="color: #0b27f9;"></i></p>
                            <p>ALL SALES</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bdarkGreen white quick-button large" href="{{url('/products/create')}}">
                        <div class="text-center">
                            <p><i class="fas fa-warehouse" style="color: #a97e0a;"></i></p>
                            <p>ADD PRODUCT</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="blightOrange white quick-button large" href="{{url('/purchases')}}">
                        <div class="text-center">
                            <i class="fas fa-cart-arrow-down" style="color: #e24603;"></i> <p></p>
                            <p>LIST PURCHASES</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bred white quick-button large" href="{{url('/contacts?type=supplier')}}">
                        <div class="text-center">
                            <p><i class="fas fa-hammer" style="color: #3615b7;"></i></p>
                            <p>SUPPLIERS</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bpink white quick-button large" href="{{url('/contacts?type=customer')}}">
                        <div class="text-center">
                            <p><i class="fas fa-tv" style="color: #8007a2;"></i></p>
                            <p>CUSTOMERS</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bgrey white quick-button large" href="{{url('/stock-transfers')}}">
                        <div class="text-center">
                            <p><i class="fas fa-address-book" style="color: #0bacc1;"></i></p>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bgrey white quick-button large" href="{{url('/shipments')}}">
                        <div class="text-center">
                            <p><i class="fas fa-truck-moving" style="color: #0840a0;"></i></p>
                            <p>DELIVERY</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="blightBlue white quick-button large" href="{{url('/pos')}}">
                        <div class="text-center">
                            <p><i class="fas fa-cash-register" style="color: #791111;"></i></p>
                            <p>LIST POS SALES</p>
                        </div>
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bblue white quick-button large" href="{{url('/expenses')}}">
                        <div class="text-center">
                ...
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bblue white quick-button large" href="{{url('/purchases/create')}}">
                        <div class="text-center">
                            <p><i class="fas fa-shopping-cart" style="color: #0b8920;"></i></p>
                            <p>ADD PURCHASES</p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-1 col-md-2 col-xs-6">
                    <a class="bblue white quick-button large" href="{{url('/expenses/create')}}">
                        <div class="text-center">
                            <p><i class="fas fa-receipt" style="color: #f00a15;"></i></p>
                            <p>ADD EXPENSES</p>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="blue"><i class="fa fa-book	"></i><span class="break"></span>Speedy Reports</h3>
                    </div>
                    <div class="box-content">
                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-warning btn-xl js-scroll-trigger" href="{{url('/')}}/reports/profit-loss" target="_self">
                                <i class="fas fa-address-book" style="color: #0bacc1;"></i> Profits & Loss Reports
                            </a>
                        </div>
                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-info btn-xl js-scroll-trigger" href="{{url('/')}}/reports/purchase-sell" target="_self">
                                <i class="fa fa-balance-scale" aria-hidden="true"></i> Purchases And Sales
                            </a>
                        </div>
                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-success btn-xl js-scroll-trigger" href="{{url('/')}}/reports/stock-expiry" target="_self">
                                <i class="fa fa-bell-slash" aria-hidden="true"></i> Lists Stocks Expiry
                            </a>
                        </div>
                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-danger btn-xl js-scroll-trigger" href="{{url('/')}}/reports/customer-supplier" target="_self">
                                <i class="fa fa-server" aria-hidden="true"></i> Customers/Suppliers
                            </a>
                        </div>

                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-info btn-xl js-scroll-trigger" href="{{url('/')}}/reports/trending-products" target="_self">
                                <i class="fas fa-award" style="color: #059407;"></i> List Trending Products
                            </a>
                        </div>

                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-warning btn-xl js-scroll-trigger" href="{{url('/')}}/reports/items-report" target="_self">
                                <i class="fa fa-address-card" aria-hidden="true"></i> List of Items  Reports
                            </a>
                        </div>

                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-danger btn-xl js-scroll-trigger" href="{{url('/')}}/reports/product-purchase-report" target="_self">
                                <i class="fa fa-shopping-cart" aria-hidden="true"></i> Product Purchases
                            </a>
                        </div>

                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-info btn-xl js-scroll-trigger" href="{{url('/')}}/reports/product-sell-report" target="_self">
                                <i class="fa fa-shopping-basket" aria-hidden="true"></i> Products Sell Report
                            </a>
                        </div>

                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-warning btn-xl js-scroll-trigger" href="{{url('/')}}/reports/purchase-payment-report" target="_self">
                                <i class="fas fa-donate" style="color: #153c7e;"></i> All Purchase Payment
                            </a>
                        </div>

                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-success btn-xl js-scroll-trigger" href="{{url('/')}}/reports/sell-payment-report" target="_self">
                                <i class="fa fa-table" aria-hidden="true"></i> Sell Payment Reports
                            </a>
                        </div>
                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-danger btn-xl js-scroll-trigger" href="{{url('/')}}/reports/expense-report" target="_self">
                                <i class="fas fa-money-check-alt" style="color: #636411;"></i> List Expenses Report
                            </a>
                        </div>
                        <div class="col-lg-1 col-md-2 col-xs-6">
                            <a class="m-1 btn btn-info btn-xl js-scroll-trigger" href="{{url('/')}}/reports/activity-log" target="_self">
                                <i class="fas fa-user-circle fa-lg" style="color: #971102;"></i> List Activity Logs
                            </a>
                        </div>
                    </div>
