<!-- Main Footer -->
  <footer class="main-footer no-print">
    ...
    <!-- Default to the left -->
    <small>
    	{{ config('app.name', 'ultimatePOS') }} - Click <a href="https://chikkahub.com/CellAirTecnologyInnovation">here</a> find out How to Use Cellair Technology Innovation System. | Copyright &copy; {{ date('Y') }} All rights reserved.
    </small>
